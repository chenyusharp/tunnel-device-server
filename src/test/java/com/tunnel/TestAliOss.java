...
public class TestAliOss {
    ...
    private static String accessKeyId = "LTAIz5RBnx1sxk1j";
    private static String accessKeySecret = "2gN8qZo6X5QPqJf1fMvW6FANrYun6x";
    private static String bucketName = "tunnel-img";
    private static String key = "products/123.txt";
     ...
     */
       ...
       OSSClient ossClient = (OSSClient) new OSSClientBuilder().build(endpoint, accessKeyId, accessKeySecret);
        ...
        PutObjectResult result =  ossClient.putObject(new PutObjectRequest(bucketName, key, createSampleFile()));
